...
/**
 * This class contains static methods that are used to calculate the One-Time Password (OTP) using
...
public class OneTimePasswordAlgorithm {
    ...
    /**
     * This method uses the JCE to provide the HMAC-SHA-1 algorithm. HMAC computes a Hashed Message
     * Authentication Code and in this case SHA1 is the hash algorithm used.
     *
     * @param keyBytes
     ...
     * @param codeDigits
     *            the number of digits in the OTP, not including the checksum, if any. Valid values
     *            are between 3 and 8 inclusive.
     * @param addChecksum
    ...
    static public String generateOTP(byte[] secret, long movingFactor, int codeDigits,
        ...
        return generateOTPFromText(secret, text, codeDigits, addChecksum, truncationOffset);
    }
     ...
     *            the shared secret
     * @param text
     *            The data input. This is an alternative to the movingFactor in the other variant of
     *            this method.
     * @param codeDigits
     *            the number of digits in the OTP, not including the checksum, if any. Valid values
     *            are between 3 and 8 inclusive.
